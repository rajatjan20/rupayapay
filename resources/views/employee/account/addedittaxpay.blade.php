        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul class="nav nav-tabs" id="transaction-tabs">
                    @if($form == "create")
                    <li class="active"><a data-toggle="tab" class="show-pointer" data-target="#purchase-order">New Tax Payment</a></li> 
                    @else
                    <li class="active"><a data-toggle="tab" class="show-pointer" data-target="#purchase-order">Edit Tax Payment</a></li> 
                    @endif
                </ul>
            </div>
            <div class="panel-body">
                <div class="tab-content">
                    <div id="purchase-order" class="tab-pane fade in active">
                       ...
                       <div class="row">
                           <div class="col-sm-12">
                            <form method="POST" class="form-horizontal" role="form" id="tax-payment-form">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="input" class="col-sm-3 control-label">TAX Payment Doc Number:</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="tax_payment_no" id="tax_payment_no" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input" class="col-sm-3 control-label">TAX Payment Date:</label>
                                            <div class="col-sm-6">
                                                <div class="input-group date">
                                                    <input type="text" name="tax_payment_date" id="tax_payment_date" class="form-control" value="" placeholder="YY-MM-DD">
                       ...
                       @endif
                        ...
                        <div id="tax-payment-response-message-modal" class="modal fade">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <strong id="tax-payment-success-response" class="text-success text-center"></strong>
                                        <strong id="tax-payment-failed-response" class="text-warning text-center"></strong>
                                    </div>
