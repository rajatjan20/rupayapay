...
<body>
    ...
    <script type="text/javascript" src="{{ asset('js/merchantempapp.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/paylink.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/searchmerchantemp.js') }}"></script>
