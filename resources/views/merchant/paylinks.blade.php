...
<section id="about-1" class="about-1">
    ...
    <div class="row">
        ...
        <div class="content-1 pt-4 pt-lg-0">
            <h3>Welcome to Rpaylink Dashboard </h3>
            <p class="font-italic">
        ...
        <img src="/assets/img/merchant-paylink.png" width="400" height="250" class="img-fluid" id="img-dash" alt="merchant-paylink.png">
        </div>
    </div>
                                        ...
                                        <div class="tab-content">
                                            <div id="add-paylink" class="tab-pane fade in active">
                                                ...
                                                <form class="form-horizontal" id="paylinkadd" autocomplete="off">
                                                    ...
                                                    <label class="control-label col-sm-3" for="sendmessage">Send Auto Reminder</label> 
                                                    <div class="col-sm-2">
                                                        <div class="checkbox">
                                                            <label>
                                        ...
                                        <div class="tab-content">
                                            <div id="add-paylink" class="tab-pane fade in active">
                                                ...
                                                <form class="form-horizontal" id="paylink-edit">
                                                    ...
                                                    <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-4">
                                                        <button type="submit" id="paylink-add" class="btn btn-primary btn-block">Submit</button>
                                                    </div>
                                                    </div>
                                                    <input type="hidden" name="id" value="">
                                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    ...
                                    <form class="form-horizontal" id="quick-link-form">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" name="paylink_amount" id="paylink_amount" value="">
